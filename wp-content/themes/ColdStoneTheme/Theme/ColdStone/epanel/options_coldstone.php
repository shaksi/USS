...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		.tnavinner ul li a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		.bnavinner ul li a { color: #<?php echo(get_option($shortname.'_color_catslink')); ?>; }
		.post-info { color: #<?php echo(get_option($shortname.'_color_postinfo')); ?>; }
		.feat_post h2 a { color:#<?php echo(get_option($shortname.'_color_featheader')); ?>; }
		.feat_post { color:#<?php echo(get_option($shortname.'_color_feattext')); ?>; }
		.side_roll h3 { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?>; }
		.sub_article h3 a, .subpost h3 a { color:#<?php echo(get_option($shortname.'_color_headings_title')); ?>; }
		.sub_article h3 a, .subpost h3 a { background-color:#<?php echo(get_option($shortname.'_color_headingsbg_title')); ?>; }
		.single_post h2 a, .single_post h1 a { color:#<?php echo(get_option($shortname.'_color_heading')); ?>; }
	</style>
