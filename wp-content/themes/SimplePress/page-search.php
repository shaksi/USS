                        ...
                        <?php }; ?>
							...
							<div id="et-search">
								<div id="et-search-inner" class="clearfix">
									<p id="et-search-title"><span><?php _e('search this website','SimplePress'); ?></span></p>
									<form action="<?php bloginfo('url'); ?>" method="get" id="et_search_form">
										<div id="et-search-left">
											...
											<p id="et_choose_posts"><label><input type="checkbox" id="et-inc-posts" name="et-inc-posts"> <?php _e('Posts','SimplePress'); ?></label></p>
											<p id="et_choose_pages"><label><input type="checkbox" id="et-inc-pages" name="et-inc-pages"> <?php _e('Pages','SimplePress'); ?></label></p>
											<p id="et_choose_date">
												<select id="et-month-choice" name="et-month-choice">
													<option value="no-choice"><?php _e('Select a month','SimplePress'); ?></option>
													<?php 
										...
										<div id="et-search-right">
											...
											<input class="et_search_submit" type="submit" value="<?php _e('Submit','SimplePress'); ?>" id="et_search_submit" />
										</div> <!-- #et-search-right -->
									</form>
